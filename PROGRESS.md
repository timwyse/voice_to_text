...
Working macOS app, installed at `/Applications/Voice to Text.app`. Branch `fix-polishing-use-openai` has the latest fixes ([PR #1](https://github.com/timwyse/voice_to_text/pull/1), awaiting merge).
